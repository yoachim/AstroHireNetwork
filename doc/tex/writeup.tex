...
\begin{figure*}
  ...
  \caption{The fraction of Astronomy PhDs still active as first authors.  Error bars show ranges computed by comparing the curves to those of just authors with unique names and uique names where all records are assumed to be linked.   \label{fig:retention_curve}}
\end{figure*}
