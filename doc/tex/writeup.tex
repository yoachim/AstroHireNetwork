...
\section{TO DO}
\begin{itemize}
  \item{Should I try dropping Icarus from the astro definition? }
\end{itemize}
...
\begin{figure*}
  \plottwo{../../plots/single_example_network_5.pdf}{../../plots/single_example_network_6.pdf}
  \caption{Example of an ADS networks that suffers from under-linking.  (e) Only 20 of the 24 entries can be linked back to \citet{Ostrowski10}, but that results in a three year gap (2012 vs 2015).  (f) The under-linked network of \citet{Capelo12}.  A single ADS entry in the future could link a network back together.}
\end{figure*}
...
\begin{figure*}
  \plotone{../../plots/span_active_curves.pdf}
