...
Note:  The curves looked weird if we included years before 1997. This could be because the job market was diffferent at that time, or it could be that ADS completeness changes. On their FAQ (\url{http://adsabs.harvard.edu/abs_doc/faq.html#complete}) ADS notes they transitioned to getting abstracts directly from journals in the middle of 1995.
